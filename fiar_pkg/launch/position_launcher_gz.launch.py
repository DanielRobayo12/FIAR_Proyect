...
def generate_launch_description():
    ...
    spawn_fiar_controller = Node(
        package='controller_manager',
        executable='spawner',
        name='fiar_controller',
        arguments=[
            'fiar_controller',
            '--controller-manager', '/controller_manager',
            '--controller-manager-timeout', '120'
    ...
    # Spawn the wheel controller.
    spawn_fiar_wheel_controller = Node(
        package='controller_manager',
        executable='spawner',
        name='fiar_wheel_controller',
        arguments=[
            'fiar_wheel_controller',
            '--controller-manager', '/controller_manager',
            '--controller-manager-timeout', '120'
        ],
        parameters=[{'use_sim_time': use_sim_time}],
